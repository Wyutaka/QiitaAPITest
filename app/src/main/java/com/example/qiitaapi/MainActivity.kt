...
import com.example.qiitaapi.Network.QiitaClient
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        listView.onItemClickListener = OnItemClickListner()
    }
    ...
    private inner class OnKeyListener : View.OnKeyListener {
        ...
        override fun onKey(view: View, keyCode: Int, keyEvent: KeyEvent): Boolean {
            ...
            if (!TextUtils.isEmpty(text)) {
                ...
                Log.d("test", request.request().url().toString())
    ...
    private inner class OnItemClickListner : AdapterView.OnItemClickListener {
